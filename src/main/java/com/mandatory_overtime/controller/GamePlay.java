...
public class GamePlay {
    ...
    /**
     * THIS METHOD STARTS A NEWGAME FROM INTRODUCTION Starts gameIntro and then startmenu() start
     * from new or start from save.
     *
     * @throws IOException
     */
...
//    this parses userInput into 1st word == verb and last word == noun
    ...
    private String gameSynonymCommands(String verb) {
        String[] getArray = new String[]{"get", "grab", "pick", "take", "acquire", "obtain", "gain",
            "acquire", "extract", "capture", "procure", "snag", "fetch", "buy", "purchase"};
        String[] goArray = new String[]{"go", "move", "travel", "progress", "proceed", "enter"};
        String[] interactArray = new String[]{"interact", "confront", "talk", "speak",
            "collaborate", "fight", "encounter", "converse", "approach"};
        ...
        do {
            ...
            try {
                ...
                if (verb.equals("help")) {
                    ...
                    try {
                        building.moveRooms2(noun);
                    } catch (IllegalMoveException | MissingRequirementException e) {
                    ...
                    try {
                        itemDescription = building.inspectItem(noun);
                        // THIS WILL BE ON THE GUI
                        System.out.println(itemDescription);
                    } catch (CantGetItemException e){
                        System.out.println("Cant get the item");
                    }
